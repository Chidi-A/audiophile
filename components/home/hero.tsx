...
const Hero = () => {
  return (
    <section className=" bg-center  relative">
      ...
      <Container>
        <div className="flex items-center justify-center lg:justify-start h-svh max-h-240">
          <div className="max-w-160 flex flex-col gap-10 text-center lg:text-left items-center lg:items-start">
            <div className="flex flex-col gap-6">
              <div className="text-overline text-white opacity-50 tracking-[10px]">
                New Product
              </div>
              <h1 className="text-white">XX99 Mark II Headphones</h1>
              <p className="text-body text-white opacity-70 max-w-[350px] mx-auto lg:mx-0">
